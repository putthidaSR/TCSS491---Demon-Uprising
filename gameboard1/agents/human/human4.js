...
//Human4
function Human4(game, board, spritesheetRun, spritesheetAttack, spritesheetRun2, spriteSheetAttack2) {
	
	this.animation = new Animation(spritesheetRun, 10, 90, 60, 75, 3, 0.1, 6, true);
	this.animation2 = new Animation(spritesheetRun2, 20, 90, 60, 75, 3, 0.1, 6, true);
	
	this.attackAnimation = new Animation(spritesheetAttack, 30, 90, 210, 135, 3, 0.1, 9, true);
	this.attackAnimation2 = new Animation(spritesheetAttack2, 40, 90, 210, 135, 3, 0.1, 9, true);
...
Human4.prototype = new Entity();
Human4.prototype.constructor = Human4;

Human4.prototype.collide = function(other) {
	return distance(this, other) < this.radius + other.radius;
}

Human4.prototype.update = function () {
...
Human4.prototype.change = function(dir) {
	switch(dir) {
...
Human4.prototype.draw = function (ctx) {
	//console.log(this.up);
	if (this.up) {
    	...
    	this.animation2.drawFrame(this.game.clockTick, ctx, this.prevX, this.prevY, 0.55);
    } else if(this.space) {
