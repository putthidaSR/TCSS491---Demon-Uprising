...
function Human6(game, board, spritesheetWalkBack, spritesheetWalkFront, spritesheetWalkLeft, spritesheetWalkRight) {
    ...
    if(this.nextMove.x == 0) {
        ...
        this.yPosition = this.nextMove.y - 28;
    } else if(this.nextMove.x == 990){
        this.xPosition = this.nextMove.x - 45;
        this.yPosition = this.nextMove.y - 28;
    } else {
    	this.xPosition = this.nextMove.x - 16;
...
Human6.prototype.update = function () {
	...
	case "u": this.y -= 0.25; break;
	case "d": this.y += 0.25; break;
	case "l": this.x -= 0.25; break;
	case "r": this.x += 0.25; break;
	case "a": break;
