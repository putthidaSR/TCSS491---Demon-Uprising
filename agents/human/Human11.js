//Human11
function Human11(game, board, spritesheetWalkBack, spritesheetWalkFront, spritesheetWalkLeft, spritesheetWalkRight) {
	//walk back
	this.animationBack = new Animation(spritesheetWalkBack, 0, 0, 32, 45, 3, 0.15, 3, true);

	//walk front
	this.animationFront = new Animation(spritesheetWalkFront, 0, 0, 32, 45, 3, 0.15, 3, true);

	//walk left
	this.animationLeft = new Animation(spritesheetWalkLeft, 0, 0, 32, 45, 3, 0.15, 3, true);

	//walk right
	this.animationRight = new Animation(spritesheetWalkRight, 0, 0, 32, 45, 3, 0.15, 3, true);
...
Human11.prototype = new Entity();
Human11.prototype.constructor = Human11;

Human11.prototype.update = function () {
...
Human11.prototype.end = function() {
	this.isALive = false;
...
Human11.prototype.change = function(dir) {
	switch(dir) {
...
Human11.prototype.draw = function (ctx) {
	//console.log(this.up);
	if(this.isALive) {
		//health
